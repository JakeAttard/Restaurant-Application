            ...
            <div class="ecommerce-widget">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted">Estimated Monthly Revenue</h5>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted">Total Monthly Customers</h5>
                                <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted">Total Monthly Reservations</h5>
                                <div class="metric-value d-inline-block">
                                        ...
                                        @foreach ($latestReservations as $reservation)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <span class="badge-dot badge-brand mr-1"></span>Small Table
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
