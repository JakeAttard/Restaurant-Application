                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2/2/2020</td>
                                         <td>
                                            <a href="{{ asset ('/admin/food-categories/1/edit')}}">
                                                <i class="far fa-edit"></i>
                                            </a>
                                        </td>
                                        <td>
                                        <a href="{{ asset ('/admin/food-categories/1/delete')}}" onclick="if (!confirm('Are you sure you want to delete category?')) { return false; }">
