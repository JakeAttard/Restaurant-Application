                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" onclick="event.preventDefault();
                                                    document.getElementById('delete-food-categories-{{$category->id}}').submit();">
                                                    <i class="far fa-trash-alt"></i>
                                                </a>

                                                <form id="delete-food-categories-{{$category->id}}" action="/admin/food-categories/{{$category->id}}/delete" method="POST" style="display: none;">
                                                    @method('DELETE')
                                                    @csrf
                                                </form>
                                            </td>
