            ...
            <ul class="navbar-nav flex-column">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                ...
                                <div id="submenu-1-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{asset ('/admin/food-categories')}}">All Food Categories <span class="badge badge-secondary">New</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{asset ('/admin/food-categories/create')}}">New Food Category <span class="badge badge-secondary">New</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-1-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{asset ('/admin/food-items')}}">All Food Items <span class="badge badge-secondary">New</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{asset ('/admin/food-items/create')}}">New Food Item <span class="badge badge-secondary">New</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-5" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ asset('/admin/settings/general')}}">General Settings <span class="badge badge-secondary">New</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ asset('/admin/settings/seo')}}">SEO <span class="badge badge-secondary">New</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ asset('/admin/settings/social')}}">Social Media <span class="badge badge-secondary">New</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
