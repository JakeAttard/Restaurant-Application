...
View::composer(['home', 'pages/about', 'pages/contact', 'pages/offers', 'pages/offers', 'pages/reservations', 'pages/thank-you', 'menu/all-categories', 'menu/single-menu'], function ($view) {
